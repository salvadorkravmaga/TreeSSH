...
def upload_file(sender,filename):
	try:
		additional1 = "UPLOAD"
		...
		if filesize <= 1 and filesize > 0:
			...
			additional2 = filename2 + "|" + filename_details
			with open(os.path.join("uploads","",filename), "rb") as file_to_upload:
				bytes = file_to_upload.read(1048576)
